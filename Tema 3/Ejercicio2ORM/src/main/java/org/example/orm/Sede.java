...
public class Sede {
    ...
    private Collection<Departamento> departamentosByIdSede;
    ...
    public Collection<Departamento> getDepartamentosByIdSede() {
        return departamentosByIdSede;
    }

    public void setDepartamentosByIdSede(Collection<Departamento> departamentosByIdSede) {
    ...
    public String toString() {
        return "Sede{" +
                "idSede=" + idSede +
                ", nomSede='" + nomSede + '\'' +
                ", departamentosByIdSede=" + departamentosByIdSede +
                '}';
    }
}
